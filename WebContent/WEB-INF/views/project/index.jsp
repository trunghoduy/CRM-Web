	...
	<div class="d-flex justify-content-between">
		...
		<div id="admin-wrapper">
			...
			<section id="admin-content" class="p-3">
                ...
                <div class="row">
                    <div class="col-md-8">
                        <a href="<c:url value="<%=Path.PROJECT_ADD %>" />" class="btn btn-primary">Thêm mới</a>
                    </div>
                    <div class="col-md-4">
                ...
                <table class="table table-bordered table-hover mt-3">
                    ...
                    <c:forEach items ="${ projects }" var ="item">
                     	<tr>
                            ...
                            <td>${ item.fullName }</td>
                            <td>
                                <a href="<c:url value="<%=Path.PROJECT_EDIT %>" />?id=${item.id}" class="btn btn-sm btn-info">
                                    <i class="fa fa-pencil-square-o"></i>
                                </a>
                                <a href="<c:url value="<%=Path.PROJECT_DELETE %>" />?id=${item.id}" class="btn btn-sm btn-danger">
